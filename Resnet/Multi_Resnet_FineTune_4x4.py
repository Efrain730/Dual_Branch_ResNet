...
model_name='Multi_Resnet_FineTune4x4_2'
...
#32*32
res_normal_input = single_layer(input=x_normal_image,in_channel=1,out_channel=64,conv_ksize=4,layer_name='res_normal_input',relu=True,trans=False)
res_normal_maxpool = tf.nn.max_pool(res_normal_input,ksize=[1,2,2,1],strides=[1,2,2,1],padding='SAME')
res_lamda_input = single_layer(input=x_lamda_image,in_channel=3,out_channel=64,conv_ksize=4,layer_name='res_lamda_input',relu=True,trans=False)
